...
var audioCB = [48, 48, 48, 48, 48, 48]; //0,..,600,600,3000,600 | 0,..,3000,3000,600,3000 | 0,..,600,3000,600,600 | 0,..,3000,600,3000,3000 | 0,..,600,600,600,3000 | 0,..,3000,3000,3000,600
var audioReal = [];
// END counterbalance
...
function alterCanvas() {
  ...
  function redraw() {
    if (trialNumberCounter < 288) {
      ...
      var aud = 0;
      var tempH = 4;
      if (redrawCounter == redrawCounterMax - 4) {
        tempH = 0;
      }
      if (redrawCounter == redrawCounterMax - 3) {
        tempH = 1;
      }
      if (redrawCounter == redrawCounterMax - 2) {
        tempH = 2;
      }
      if (redrawCounter == redrawCounterMax - 1) {
        tempH = 3;
      ...
      if (tempH != 4) {
        if (hertz[tempH] == "6") aud = 600;
        if (hertz[tempH] == "3") aud = 3000;
      }
