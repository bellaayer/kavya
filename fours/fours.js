...
var audioCB = [48, 48, 48, 48, 48, 48]; //no audio | no audio | 600*4,0.. | 3000*4,0.. | 0..,600*4 | 0..,3000*4
var audioReal = [];
// END counterbalance
  ...
  function redraw() {
    if (trialNumberCounter < 288) {
      ...
      if (redrawCounter == 0) {
        ...
        //Initialize audio
        //no audio | no audio | 600*4,0.. | 3000*4,0.. | 0..,600*4 | 0..,3000*4
        while (hertz == "") {
        ...
        if (hertz == "600=>0") audioReal.push("600hz in first four frames");
        if (hertz == "3000=>0") audioReal.push("3000hz in first four frames");
        if (hertz == "0=>600") audioReal.push("600hz in last four frames");
        if (hertz == "0=>3000") audioReal.push("3000hz in last four frames");
      ...
      aud = 0;
      if (redrawCounter <= 4) {
        if (hertz == "600=>0") aud = 600;
        if (hertz == "3000=>0") aud = 3000;
      }
      if (redrawCounter >= redrawCounterMax - 3) {
